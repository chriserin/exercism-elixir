...
defmodule DotTest do
  ...
  test "graph with just 2 attribute" do
    assert %Graph{attrs: [bar: 2, foo: 1]} == exprt(Dot.graph do
                                              graph [foo: 1]
                                              graph [bar: 2]
    end)
  end
  ...
  test "graph with just attribute" do
    assert %Graph{attrs: [foo: 1]} == exprt(Dot.graph do
      graph [foo: 1]
    end)
  end
